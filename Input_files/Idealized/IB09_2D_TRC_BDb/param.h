...
# else
      parameter (LLm0=350,  MMm0=500,  N=10)   !  0.5 m IB09 
# endif
...
!
      ...
      parameter (NP_XI=15,  NP_ETA=24,  NNODES=NP_XI*NP_ETA)
!      parameter (NP_XI=18,  NP_ETA=40,   NNODES=NP_XI*NP_ETA) 
!      parameter (NP_XI=12,  NP_ETA=12,   NNODES=NP_XI*NP_ETA)
      parameter (NPP=1)
