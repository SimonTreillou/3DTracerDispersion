...
#  ifdef UV_VADV_WENO5_INTWENO
              vel=flux5_weno(We(i-3,j,k),We(i-2,j,k),We(i-1,j,k),
...
#  endif
     ...
     &           u(i,j,k+2,nrhs), u(i,j,k+3,nrhs), vel)
        ...
        do i=IstrU,Iend
          if ( i.ge.imin .and. i.le.imax ) then
#  ifdef UV_VADV_WENO5_INTWENO
            vel=flux5_weno(We(i-3,j,2),We(i-2,j,2),We(i-1,j,2),
...
#  endif
     ...
     &         u(i,j,3,nrhs), u(i,j,4,nrhs), vel)
          ...
          if ( i.ge.imin .and. i.le.imax ) then
#  ifdef UV_VADV_WENO5_INTWENO
            vel=flux5_weno(We(i-3,j,N-2),We(i-2,j,N-2),We(i-1,j,N-2),
...
#  endif
     ...
     &         u(i,j,N-1,nrhs), u(i,j,N  ,nrhs), vel)
          ...
          if ( i.ge.imin .and. i.le.imax ) then
#  ifdef UV_VADV_WENO5_INTWENO
            vel=flux5_weno(We(i-3,j,1),We(i-2,j,1),We(i-1,j,1),
...
#  endif
     ...
     &         u(i,j,1,nrhs), u(i,j,2,nrhs), vel, cdif)
          ...
          if ( i.ge.imin .and. i.le.imax ) then
#  ifdef UV_VADV_WENO5_INTWENO
            vel=flux5_weno(We(i-3,j,N-1),We(i-2,j,N-1),We(i-1,j,N-1),
